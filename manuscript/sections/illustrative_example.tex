...
\begin{itemize}
  \item The public ladder currently represents one BC ground-based archetype; broader system families remain out of scope.
...
The tables and figures in this section come from versioned manuscript assets and linked run
logs. Readers can audit values and reuse the same baseline in companion modelling
analyses.

...
FHOPS establishes a transparent and reusable foundation for comparable research in forest operations planning. Immediate next work is to use this platform baseline for rolling-horizon and broader deployment studies while preserving the same scenario contract and traceability standards.

...
The software is available through Python modules and command-line wrappers, but interface choice is secondary to preserving equivalent, traceable evidence across runs. FHOPS is released as open-source software under an MIT license, with full source code, datasets, and experiment pipelines available in a public repository to support reuse and independent verification.
